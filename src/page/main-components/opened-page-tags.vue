<template>
  <div class="tags-outer-con" ref="tagCon" @DOMMouseScroll="handlescroll" @mousewheel="handlescroll">
    ...
    <div class="tags-btn">
      <a @click="tagLeft"><Icon type="ios-arrow-back" /></a>
      <a @click="tagRight"><Icon type="ios-arrow-forward" /></a>
    </div>
  </div>
</template>
<script>
export default {
  ...
  methods: {
    ...
    */
    tagRight: function () {
      if (this.tagConLeft < 0) {
        this.tagConLeft = this.tagConLeft <= -100 ? this.tagConLeft + 100 : 0
      }
    }
  },
  mounted () {
